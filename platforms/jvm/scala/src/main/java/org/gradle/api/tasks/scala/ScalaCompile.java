...
public abstract class ScalaCompile extends AbstractScalaCompile {
     ...
     */
    @Classpath
    @ReplacesEagerProperty(replacedGetters = @ReplacedGetter(name = "getScalaCompilerPlugins"))
     ...
     */
    @Classpath
    @ReplacesEagerProperty(replacedGetters = @ReplacedGetter(name = "getZincClasspath"))
