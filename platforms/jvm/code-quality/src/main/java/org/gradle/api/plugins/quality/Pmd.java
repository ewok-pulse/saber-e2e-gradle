...
public abstract class Pmd extends AbstractCodeQualityTask implements Reporting<PmdReports> {
     ...
     */
    @Classpath
    @ReplacesEagerProperty(replacedGetters = @ReplacedGetter(name = "getPmdClasspath"))
     ...
     */
    @Input
    @ReplacesEagerProperty(replacedGetters = @ReplacedGetter(name = "getTargetJdk"))
     ...
     */
    @LocalState
    @ReplacesEagerProperty(replacedGetters = @ReplacedGetter(name = "getIncrementalCacheFile"))
