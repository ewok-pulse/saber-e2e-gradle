 ...
 * [FileTreeInternal]). Adds a [NarrowingCodec] declaration so that a
...
class SourceDirectorySetCodec(
    ...
    NarrowingCodec<FileTreeInternal> {
    ...
    override val narrowingResolution: String = "Use a ConfigurableFileCollection or ConfigurableFileTree instead."
}
