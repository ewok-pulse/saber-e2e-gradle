 ...
 * is a [FileCollectionInternal]). Adds a [NarrowingCodec] declaration so that
...
class ConfigurationCodec(
    ...
    NarrowingCodec<FileCollectionInternal> {
    ...
    override val narrowingResolution: String = "Use a ConfigurableFileCollection instead."
}
