...
/**
 * A codec whose decode contract returns a type that may be strictly narrower
 ...
 * opts in.
 */
interface NarrowingCodec<T : Any> : Codec<T> {
     ...
     * accept the decoded type. Each [NarrowingCodec] must supply a concrete
