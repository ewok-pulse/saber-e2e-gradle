...
interface WriteContext : MutableIsolateContext, Encoder {
     ...
     * whether the codec is a [NarrowingCodec] whose decoded type cannot fit a field).
     *
     * Implementations backed by a `BindingsBackedCodec` should override this to
     * enable store-time narrowing checks for their encoded values.
     *
